 ...
 (function(t, e) {
    ...
    function re(e, n, r) {
        ...
        function s(n) {
            ...
            u = B.start.getMonth(),
            d = f(new Date);
            for (s += "<table class='fc-border-separate' style='width:100%' cellspacing='0'><thead id='tHead'><tr>", De && (s += "<th class='fc-week-number " + c + "'/>"), r = 0; re > r; r++) o = F(0, r),
            s += "<th class='fc-day-header fc-" + Se[o.getDay()] + " " + c + "'><div class='box'><span class='week'>"+Se[o.getDay()]+"</span><span class='select_box'><input type='checkbox' class='hide'></span></div></th>";
            for (s += "</tr></thead><tbody id='tBody'>", r = 0; ne > r; r++) {
				...
				o.getMonth() == u && +o < +d && i.push("disable"),
                //+o == +d && (i.push("fc-today"), i.push(be + "-state-highlight")),
                s += "<td class='" + i.join(" ") + "'" + " data-date='" + Fe(o, "yyyy-MM-dd") + "'" + ">" + "<div class='box'>",
                n && (s += "<div class='fc-day-number'>" + o.getDate() + "</div>"),
				o.getMonth() == u && +o >= +d && (s += "<span class='select_box'><input class='hide' type='checkbox' name='list_checkbox'></span>"),
                s += "<div class='fc-day-content'><div id='fc-day-content'></div></div></div></td>";
                s += "</tr>"
            }
            s += "</tbody></table>",
            _(),
    ...
    function ce() {
        ...
        function a(e) {
            ...
            a,
            o,
            i = k(T(e, t.map(e, C), m.visStart, m.visEnd)),
            s = i.length,
            c = [];
    ...
    var ye = {
        ...
        buttonText: {
            prev: "<span id='prev_icon' class='fc-text-arrow'>&lsaquo;</span>",
            next: "<span id='next_icon' class='fc-text-arrow'>&rsaquo;</span>",
